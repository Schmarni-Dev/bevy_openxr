...
fn main() {
    ...
    App::new()
        ...
        .add_systems(
            Update,
            socket_interactions.before(update_interactable_states).run_if(xr_only()),
        )
        .add_systems(Update, prototype_interaction_input.run_if(xr_only()))
        .add_systems(Update, update_interactable_states.run_if(xr_only()))
        .add_systems(Update, update_grabbables.after(update_interactable_states).run_if(xr_only()))
